...
const colors = {
  gradients: {
    blue1: `linear-gradient(135deg, ${gold} 0%, ${white} 100%)`,
    blue2: `linear-gradient(135deg, ${white} 0%, ${gold} 100%)`,
    blue3: `linear-gradient(127.55deg, ${gold} 3.73%, ${white} 92.26%)`,
    blue4: `linear-gradient(-20deg, ${gold} 0%, ${white} 100%)`,
    blue5: `linear-gradient(135deg, ${white} 10%, ${gold} 100%)`,
...
export const GoldWhiteTheme = createTheme({
  colors: {
    ...
    secondary: {
      lighter: lighten(white, 0.85),
      light: lighten(white, 0.25),
      main: white,
      dark: darken(white, 0.2)
    },
    primary: {
  ...
  sidebar: {
    background: white,
    textColor: gold,
    dividerBg: alpha(black, 0.1),
    menuItemColor: gold,
    menuItemColorActive: black,
    menuItemBg: white,
    menuItemBgActive: gold,
    menuItemIconColor: gold,
    menuItemIconColorActive: black,
  ...
  palette: {
    ...
    secondary: {
      light: lighten(white, 0.3),
      main: white,
      dark: darken(white, 0.2)
    },
    background: {
      default: white,
      paper: lighten(white, 0.02)
    },
    text: {
      primary: gold,
