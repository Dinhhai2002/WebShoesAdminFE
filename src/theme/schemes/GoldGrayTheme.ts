...
const colors = {
  gradients: {
    blue1: `linear-gradient(135deg, ${gold} 0%, ${gray} 100%)`,
    blue2: `linear-gradient(135deg, ${gray} 0%, ${gold} 100%)`,
    blue3: `linear-gradient(127.55deg, ${gold} 3.73%, ${gray} 92.26%)`,
    blue4: `linear-gradient(-20deg, ${gold} 0%, ${gray} 100%)`,
    blue5: `linear-gradient(135deg, ${gray} 10%, ${gold} 100%)`,
...
export const GoldGrayTheme = createTheme({
  colors: {
    gradients: {
    ...
    secondary: {
      lighter: lighten(gray, 0.85),
      light: lighten(gray, 0.25),
      main: gray,
  ...
  palette: {
    ...
    secondary: {
      light: lighten(gray, 0.3),
      main: gray,
      dark: darken(gray, 0.2)
    },
    background: {
      default: gray,
      paper: darken(gray, 0.1)
    },
    text: {
      primary: gold,
