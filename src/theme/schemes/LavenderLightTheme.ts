...
const themeColors = {
  primary: '#8B5CF6',    // Lavender primary
  secondary: '#64748B',  // Modern slate
  success: '#10B981',    // Modern emerald
  warning: '#F59E0B',    // Modern amber
  error: '#EF4444',      // Modern red
  info: '#A78BFA',       // Light lavender
  black: '#1E293B',      // Modern slate dark
  white: '#ffffff',
  primaryAlt: '#7C3AED'  // Dark lavender
};

const colors = {
  gradients: {
    blue1: 'linear-gradient(135deg, #C4B5FD 0%, #8B5CF6 100%)',
    blue2: 'linear-gradient(135deg, #DDD6FE 0%, #8B5CF6 100%)',
    blue3: 'linear-gradient(127.55deg, #7C3AED 3.73%, #6D28D9 92.26%)',
    blue4: 'linear-gradient(-20deg, #8B5CF6 0%, #6D28D9 100%)',
    blue5: 'linear-gradient(135deg, #EDE9FE 10%, #7C3AED 100%)',
    ...
    purple1: 'linear-gradient(135deg, #C4B5FD 0%, #8B5CF6 100%)',
  ...
  shadows: {
    ...
    info:
      '0px 1px 4px rgba(167, 139, 250, 0.25), 0px 3px 12px 2px rgba(167, 139, 250, 0.35)',
    primary:
      '0px 1px 4px rgba(139, 92, 246, 0.25), 0px 3px 12px 2px rgba(139, 92, 246, 0.35)',
    warning:
...
export const LavenderLightTheme = createTheme({
  // ... rest of the theme configuration remains the same as ModernLightTheme
  colors: {
