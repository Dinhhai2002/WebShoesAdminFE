...
const colors = {
  gradients: {
    blue1: `linear-gradient(135deg, ${gold} 0%, ${black} 100%)`,
    blue2: `linear-gradient(135deg, ${black} 0%, ${gold} 100%)`,
    blue3: `linear-gradient(127.55deg, ${gold} 3.73%, ${black} 92.26%)`,
    blue4: `linear-gradient(-20deg, ${gold} 0%, ${black} 100%)`,
    blue5: `linear-gradient(135deg, ${black} 10%, ${gold} 100%)`,
...
export const GoldBlackTheme = createTheme({
  colors: {
    gradients: {
    ...
    secondary: {
      lighter: lighten(black, 0.85),
      light: lighten(black, 0.25),
      main: black,
  ...
  palette: {
    ...
    secondary: {
      light: lighten(black, 0.3),
      main: black,
      dark: darken(black, 0.2)
    },
    background: {
      default: black,
      paper: darken(black, 0.1)
    },
    text: {
      primary: gold,
